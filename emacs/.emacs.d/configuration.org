...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates '(("k" "knowledge" entry (file+olp+datetree "~/org/capture.org" "Knowledge") (file "~/org/templates/knowledge-capture.org"))
                                ("t" "Todo" entry (file+headline "~/org/home.org" "INBOX") "* TODO %?\n  %i\n  %a")
