...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(yasnippet-snippets flycheck-prospector dracula-theme doom-themes traad)
