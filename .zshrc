...
# ANTIGEN
  if [ $(uname) = "Linux" ]; then
    ...
    export PATH=/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:$JAVA_HOME/jre/bin:~/anaconda3/bin:/Applications/Postgres.app/Contents/Versions/latest/bin:/Library/TeX/texbin:~/.dotfiles/.tex
  fi
